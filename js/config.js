export default {
  name: "Mika Asuma" , // actual name of the recipient (Mandatory)

  nickname: "R.A.N" , // nickname(optional)

  pic: "https://prnt.sc/StBGeShSoLJB", // image url of recipients (Mandatory)
